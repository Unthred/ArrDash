...
public static class SettingsHelpTexts
{
    ...
    public const string MediaServerPlayWebhooks = "Emby and Plex notify ArrDash on completed plays; ArrDash scrobbles them to Trakt for the mapped user (Squiggley). Emby: playback.stop (Premiere required). Plex: media.scrobble. Token lives in OpenBao (secret/arrdash/webhook-token).";
