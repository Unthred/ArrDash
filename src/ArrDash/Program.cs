...
builder.Services.AddSingleton<CleanupCandidatesRepository>();
builder.Services.AddSingleton<MediaInventorySyncService>();
builder.Services.AddHostedService(sp => sp.GetRequiredService<MediaInventorySyncService>());
...
builder.Services.AddSingleton<CleanupFeatureAvailability>();
